export const SITE_CONFIG = {
  name: "Saraswati Industrial Services",
  shortName: "SIS",
  tagline: "Helping you discover better version of yourself and your Company",
  founded: "2011",
  location: "Bengaluru, Karnataka, India",
  fullAddress:
    "#7036, Sobha Forest View Apartments, 100 Feet Vajarahalli Road, Off Kanakapura Road, Bengaluru - 560109",
  phone1: "+91 9845043202",
  phone2: "+91 80 49511130",
  email: "gotopssatish@gmail.com",
  linkedin: "satishps",
  whatsapp: "919845043202",
};
...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      "1-to-1 coaching for middle & senior managers, student mentoring, and company-wide mentoring for holistic growth.",
    items: [
  ...
  },
  {
    ...
    description:
      "Quality improvement, supplier assessment, organizational change management, and strategic consulting for SMEs.",
    items: [
  ...
  },
  {
    ...
    description:
      "Engaging talks at industry forums, engineering colleges, and professional associations inspiring action and excellence.",
    items: [
      "Guest lectures at 40+ institutions and associations",
...
export const CAREER = [
  ...
  },
  {
    ...
    org: "Spring Dynamics Private Limited, Bengaluru",
    description:
      "Served as Director of Strategy, guiding the company's strategic direction and growth in the manufacturing sector.",
  },
  {
    period: "1984 – 2007 (23+ years)",
...
export const EDUCATION = [
  {
    degree: "M.Tech (Mechanical Engineering – I.C. Engines)",
    institution: "Indian Institute of Technology (IIT), Madras",
  },
  {
    degree: "B.E. (Mechanical Engineering) – with University Rank",
...
export const CERTIFICATIONS = [
  {
    issuer: "Ipreneur, Bengaluru",
    title: "Certified Global Mentor",
    details:
      "Certified to mentor startups and manufacturing companies for holistic growth and development.",
  },
  {
    issuer: "ISO / Quality Management",
    title: "Certified Lead Auditor for QMS",
    details:
      "Qualified to lead quality management system audits across manufacturing organizations.",
  },
  {
    issuer: "CII (Confederation of Indian Industry)",
    title: "Certified Assessor – EFQM Business Excellence Model",
    details:
      "Certified by CII to assess organizations using the European Foundation for Quality Management Business Excellence framework.",
  },
];
...
export const TRAINING_MODULES = {
  purchaseSupplyChain: {
    ...
    modules: [
      ...
      "Cost Engineering to Enhance Competitiveness",
      "Advantage Through Effective Negotiations",
  ...
  quality: {
    ...
    modules: [
      ...
      "Introduction to Design Thinking and QFD",
    ],
  },
  ...
  engineering: {
    ...
    modules: [
      ...
      "Safety Practices in Industries",
    ],
  },
  collegePrograms: {
    title: "Engineering College Programs",
    icon: "BookOpen" as const,
    modules: [
      "Journey from Campus to Corporate (2 Days) – Pre/Final Year Students",
...
export const CLIENTS = {
  ...
  associations: [
    ...
    "DQS India",
    "TUV-Rheinland",
    "Whitefield Industrial Association",
  ],
};

export const BOOKS = [
  {
    title: "Knowing Is Not Same as Doing",
    subtitle: "For all the ACTION TAKERS",
    language: "English",
    year: "2017",
    description:
      "52 chapters addressing the gap between knowledge and action. Uses simple language, stories, and real-life experiences to communicate life skills and value-based guidance. For students, young graduates, and professionals seeking positive change.",
    amazonUrl: "https://www.amazon.co.uk/Knowing-Not-Same-Doing-ACTION/dp/1947586815",
    publisher: "Notion Press",
    cover: "/images/book-knowing-is-not-same-as-doing.jpg",
  },
  {
    title: "Sanjeevana",
    subtitle: "Articles & Poems with Humor",
    language: "Kannada",
    year: "",
    description:
      "A unique mixture of articles and poems with humor, based on the author's experiences in various occasions of life. Written in Kannada for regional readership.",
    amazonUrl: "",
    publisher: "Limited edition – available with author",
    cover: "/images/book-sanjeevana.jpg",
  },
  {
    title: "The Great Entrepreneur Blueprint",
    subtitle: "52 Dimensions",
    language: "English",
    year: "2021",
    description:
      "Provides 52 essential dimensions for budding entrepreneurs. Ideal for students, employees dreaming of entrepreneurship, startup founders wanting to reinforce fundamentals, and mentors guiding startups.",
    amazonUrl: "https://www.amazon.com.au/Great-Entrepreneur-Blueprint-52-Dimensions/dp/9390507308",
    publisher: "Available on Amazon & Flipkart",
    cover: "/images/book-great-entrepreneur-blueprint.jpg",
  },
  {
    title: "Lose Your Old Scissors",
    subtitle: "52 Blocks to Build the Castle of Personal Productivity",
    language: "English",
    year: "2024",
    description:
      "52 practical blocks for building personal productivity, one for each week of the year. For anyone wanting to achieve more, exploit their full potential, and lead a more fulfilled life.",
    amazonUrl: "",
    publisher: "Clever Fox Publishing",
    cover: "/images/book-lose-your-old-scissors.jpg",
  },
];
